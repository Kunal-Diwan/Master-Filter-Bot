...
async def start(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("⚙️ Command Help ⚙️", callback_data="help_data")
                ], 
                [
                ...
                [
                    InlineKeyboardButton("➕ Add me ➕", url="https://t.me/MasterFilterBot?startgroup=True")
                ] 
            ]
        ),
...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("➕ Add me ➕", url="http://t.me/MasterFilterBot?startgroup=true"),
            ...
            [
                [
                    InlineKeyboardButton(
                        "Source code 💻", url="https://github.com/DevelopedBots/Master-Filter-Bot")
                ],
                [
